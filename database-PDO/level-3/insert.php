...
if (isset($_POST['update'])) {
	...
	$sql = "INSERT INTO media (mediatype, title, rating, `description`, awards, duration, releasedate, seasons, country, lang, trailerid) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
...
<body>
    ...
    <form action="" method="POST">
		...
		<input type="number" id="awards" name="awards" value="" required><br><br>
		...
		<input type="date" name="releasedate" id="date" value="" required>
		<br><br>

		<label for="seasons">Seasons: (leave empty of not applicable)</label><br>
		<input type="number" name="seasons" id="seasons" value="">
		<br><br>
        ...
        <input type="text" id="trailerid" name="trailerid" value=""><br><br>

        <input type="submit" value="Add Media" name="update">
