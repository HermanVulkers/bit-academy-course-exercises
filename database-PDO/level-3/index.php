...
<body>
	<div class="container">
		...
		<table>
			...
			<?php while ($series_row = $series->fetch()) { ?>
				<tr>
					...
					<td><a href="edit.php?id=<?php echo $series_row['id']; ?>"><button class="edit">Edit</button><a></td>
		...
		<tr>
			...
			<?php while ($films_row = $films->fetch()) { ?>
				<tr>
					...
					<td><a href="edit.php?id=<?php echo $films_row['id']; ?>"><button class="edit">Edit</button><a></td>
		...
		<br>
		<a href="insert.php"><button class="add">Add media</button></a><br>
